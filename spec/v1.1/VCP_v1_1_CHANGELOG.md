...
VCP v1.1 introduces **5 major changes** and **13 minor enhancements** to strengthen external verifiability, improve implementation clarity, and add new capabilities for multi-party verification.
...
| Clarifications & Enhancements | 13 | Improved guidance, definitions, error types |
...
### 17. Error Event Types Standardization (Section 3.2.1) — NEW

**Type:** Enhancement

**Change:** Added standardized error event types for consistent error recording.
...
| ERR_REJECT | Rejection | WARNING |
| ERR_PARSE | Data | WARNING |
| ERR_SYNC | Synchronization | WARNING |
| ERR_RISK | Risk | CRITICAL |
| ERR_SYSTEM | System | CRITICAL |
| ERR_RECOVER | Recovery | INFO |
...
```json
{
  ...
  "CorrelatedEventID": "uuid"
}
```

**Rationale:** 
- Prevents implementation-specific error formats
- Enables consistent audit trail analysis
- Simplifies incident investigation across systems

**Migration:** OPTIONAL but RECOMMENDED. Existing implementations can add error event support without breaking changes.

---

### 18. Sidecar Architecture Reference (Appendix F) — NEW

**Type:** Documentation

**Change:** Added comprehensive sidecar architecture reference diagram and integration patterns.

**Contents:**
- Architecture overview diagram (ASCII)
- Integration patterns (API Interception, In-Process Hook, Message Queue Tap)
- Platform-specific integration table (MT4/MT5, cTrader, FIX Engine)
- Key design principles (Non-invasive, Fail-safe, Async-first)
- Deployment checklist

**Rationale:**
- Clarifies "no system modification required" positioning
- Reduces integration misunderstandings
- Provides clear reference for implementers

**Migration:** Documentation only. No implementation changes required.
