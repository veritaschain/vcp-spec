...
- **将来予約**: 耐量子アルゴリズム（DILITHIUM, FALCON）
...
| **DILITHIUM2** | CRYSTALS-Dilithium | 耐量子（NISTレベル2） | FUTURE |
| **FALCON512** | FALCON-512 | 耐量子（NISTレベル1） | FUTURE |
...
*[イベントタイプレジストリはv1.0から変更なし - 完全なリストはv1.0仕様を参照]*
...
*VeritasChain Protocol (VCP) 仕様書 v1.1 終わり*
